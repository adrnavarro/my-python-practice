...
Functions:
	...
	- calculate_magnitude(vec): Magnitude of a vector
	- calculate_distance(vec1, vec2): Euclidean distance
	- normalize_vector(vec): Normalize a vector
	- amplify_vector(vec, scalar): Amplify a vector
	- calculate_manhattan_norm(vec): Manhattan norm (L1)
